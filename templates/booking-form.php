    ...
    <?php else : ?>
        ...
        <form action="#" method="POST" class="rca-booking-form" id="rca-car-rental-agreement-form" onsubmit="return false;">
            ...
            <div class="rca-form-section">
                ...
                <!-- Hidden fields to save vehicle data as snapshot -->
                <input type="hidden" name="rca_vehicle_make" value="<?php echo esc_attr( $make ); ?>">
                <input type="hidden" name="rca_vehicle_model" value="<?php echo esc_attr( $model ); ?>">
                <input type="hidden" name="rca_vehicle_year" value="<?php echo esc_attr( $year ); ?>">
                <input type="hidden" name="rca_vehicle_vin" value="<?php echo esc_attr( $vin ); ?>">
                <input type="hidden" name="rca_vehicle_color" value="<?php echo esc_attr( $color ); ?>">
                <input type="hidden" name="rca_vehicle_plate" value="<?php echo esc_attr( $plate ); ?>">
                <input type="hidden" name="rca_vehicle_weekly_rate" value="<?php echo esc_attr( $w_rate ); ?>">
                <input type="hidden" name="rca_vehicle_title" value="<?php echo esc_attr( $vehicle->post_title ); ?>">
            </div>
            ...
            <div class="rca-form-section">
                ...
                <!-- Hidden field to save the base fee -->
                <input type="hidden" name="rca_base_fee_weekly" value="<?php echo esc_attr( $w_rate ); ?>">
